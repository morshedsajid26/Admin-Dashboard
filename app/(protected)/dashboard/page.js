              ...
              <div onClick={() => setYearIncome(!yearIncome)}>
                ...
                <div
                  className={`w-full text-center bg-white font-inter text-[14px] text-[#333333] z-30 absolute ${
                    yearIncome ? "opacity-100 h-auto visible overflow-auto" : "opacity-0 h-0 invisible overflow-hidden"
                  }`}
                >
                  {years.map((item) => (
                    <div
          ...
          <div className="mb-[30px] flex items-center justify-between">
            ...
            <div className="relative cursor-pointer">
              <div onClick={() => setYearGrowth(!yearGrowth)}>
                ...
                <div
                  className={`w-full text-center bg-white font-inter text-[14px] text-[#333333] z-30 absolute ${
                    yearGrowth ? "opacity-100 h-auto visible overflow-auto" : "opacity-0 h-0 invisible overflow-hidden"
                  }`}
                >
                  {years.map((item) => (
                    <div
