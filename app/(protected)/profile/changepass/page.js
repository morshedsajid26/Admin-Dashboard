...
<div>
      <div className='mt-6'>
        ...
        <div className='relative mt-2'>
         <input className=' w-[481px] border border-[#015093] rounded-[5px] py-[13px] px-4 outline-none font-inter text-[16px]   placeholder-[#5C5C5C] text-[#5C5C5C]' type={showPass? 'text':'password'} id='newapass' placeholder='' />
      ...
      <div className='mt-6 '>
       ...
       <div className='relative mt-2'>
         <input className=' w-[481px] border border-[#015093] rounded-[5px] py-[13px] px-4 outline-none font-inter text-[16px]   placeholder-[#5C5C5C] text-[#5C5C5C]' type={showPass1? 'text':'password'} id='newapass' placeholder='' />
      ...
      <div className='mt-6'>
        ...
        <div className='relative mt-2'>
         <input className=' w-[481px]  border border-[#015093] rounded-[5px] py-[13px] px-4 outline-none font-inter text-[16px]  text-[#5C5C5C]  placeholder-[#5C5C5C]' type={showPass2? 'text':'password'} id='newapass' placeholder='' />
